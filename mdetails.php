                    ...
                    <div class="col-sm-8">
                        <form method="post" action="seatbook.php">
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="bdate" name="bdate" placeholder="Your Name">
                                </div>
                            </div>
                            <div class="form-group form-row">
                                <label class="col-sm-4 col-form-label">Choose Theatre</label>
                                <div class="col-sm-8">
                                    <select required class="form-control" name="tid" id="tid">
                                        <option value="">Select Theatre</option>
                                        <?php
                                            $thNames = getTheatre("theatre",$pg['theatre']);
                                            foreach ($thNames as $t) {
                                        ?>
                                                <option value="<?php echo $t['tid'] ?>"><?php echo $t['tname'] ?>-<?php echo $t['location'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" readonly="readonly" value="100" required class="form-control">
                                </div>
                            </div>
